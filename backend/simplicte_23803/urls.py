"""simplicte_23803 URL Configuration
...
admin.site.site_header = "Simplicte"
admin.site.site_title = "Simplicte Admin Portal"
admin.site.index_title = "Simplicte Admin"

# swagger
api_info = openapi.Info(
    title="Simplicte API",
    default_version="v1",
    description="API documentation for Simplicte App",
)
